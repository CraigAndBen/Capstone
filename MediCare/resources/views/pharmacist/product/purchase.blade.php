                        ...
                        <div class="card-body">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        @if ($cart)
                                            @if (count($cart) > 0)
                                                    ...
                                                    <tbody>
                                                        @foreach ($cart as $key => $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form method="POST"
                                                                        action="{{ route('pharmacist.product.purchase.remove', ['key' => $key]) }}">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
                                                ...
                                                <form method="POST" action="{{ route('pharmacist.product.purchase.receipt') }}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <h1>Cashier Form</h1>
                                        <form method="POST" action="{{ route('pharmacist.product.purchase.add') }}">
                                            @csrf
                                            <div class="form-group">
