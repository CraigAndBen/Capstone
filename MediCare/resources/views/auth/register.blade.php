            ...
            <div class="auth-form">
              ...
              <h5 class="my-4 d-flex justify-content-center">Sign Up with Email address</h5> --}}
                        ...
                        <form method="POST" action="{{ route('register') }}" id="registerForm">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" name="last_name" class="form-control" id="floatingInput last_name"
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" name="password" class="form-control" id="floatingInput password"
                                    placeholder="Password" />
                                <label for="floatingInput">Password</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="password" name="password_confirmation" class="form-control"
                                    id="floatingInput password_confirmation" placeholder="password confirmation" />
                                <label for="floatingInput">Password Confirmation</label>
                            </div>
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-primary p-2" id="submitBtn">Sign Up</button>
                            </div>
                            <hr />
                        </form>
                        <h5 class="d-flex justify-content-center"><a href="{{ route('login') }}">Already have an
                                account?</a></h5>
                    </div>
                </div>
            </div>
