...
<body>
    ...
    <header class="pc-header">
        <div class="m-header mt-3">
            ...
            <a href="{{ route('staff.dashboard') }}" class="logo me-auto"><img src="{{ asset('logo.jpg') }}"
                        ...
                        <div class="dropdown-menu dropdown-notification dropdown-menu-end pc-h-dropdown">
                            @if ($count > 0)
                                ...
                                <div class="text-center py-2">
                                    <a href="{{ route('staff.notification') }}" class="btn btn-primary">Show all</a>
                                </div>
                            @else
                                <div class="dropdown-header">
        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('staff.dashboard') }}" class="pc-link"><span class="pc-micon"></span><span
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('staff.profile') }}">Update
                                    Profile</a></li>
                            <li class="pc-item"><a class="pc-link"
                                    href="{{ route('staff.profile.password') }}">Update Profile Password</a></li>
                        </ul>
                    </li>
                    <li class="pc-item pc-caption">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link"><span class="pc-micon"></span><span
                                class="pc-mtext">Notification List</span><span class="pc-arrow"><i
                                    class="ti ti-chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('staff.notification') }}">Notification</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
