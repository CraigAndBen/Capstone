                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            @foreach ($nurses as $nurse)
                                                                @if ($user->id === $nurse->account_id)
                                                                    ...
                                                                    <form
                                                                        action="{{ route('superadmin.doctor.update.status') }}"
                                                                        method="POST">
                                                                        @csrf
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 ">
                                                    <input type="date" class="form-control ml-2"
                                                        id="employment_date" placeholder="Employment Date" name="employment_date"/>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="specialties" class="form-control" id="specialties"
                                            placeholder="Specialties" readonly />
                                        <label for="floatingInput">Specialties</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="qualification" class="form-control"
                                    ...
                                    <form method="POST" action="{{ route('superadmin.store.nurse') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 ">
                                                    <input type="date" class="form-control ml-2"
                                                        id="floatingInput employment_date" placeholder="Employment Date" name="employment_date"
                                                        required />
                                                    <label for="floatingInput">Employment Date</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 ">
                                                    <input type="number" class="form-control" id="floatingInput years_of_experience"
                                                        placeholder="Years of Experience" name="years_of_experience"/>
                                                    <label for="floatingInput">Years of Experience</label>
                                                </div>
                                            </div>
