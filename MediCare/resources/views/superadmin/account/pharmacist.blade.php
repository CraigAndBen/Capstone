                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="display-6">Pharmacist Account</h1>
                        </div>
                        <div class="card-body">
                            <div class="container">
                                ...
                                @if ($users->isEmpty())
                                    <div class="alert alert-info">
                                        <span class="fa fa-check-circle"></span> No Pharmacist Account Yet.
                                    </div>
                                @else
                                    <div class="row my-4">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{ route('superadmin.update.pharmacist') }}">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                    ...
                    <div class="modal fade" id="createModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{ route('superadmin.store.pharmacist') }}">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3">
                    ...
                    <div class="modal fade" id="updatePasswordModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{ route('superadmin.pharmacist.password.update') }}">
                                        @csrf
