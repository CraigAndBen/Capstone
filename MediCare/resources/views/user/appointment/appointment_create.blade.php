                            ...
                            <div class="card-body">
                                ...
                                {{-- <form method="POST" action="{{ route('user.create.appointment') }}">
                                    ...
                                    <div class="row mt-4 text-start">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating mb-3 ">
                                                <input type="text" class="form-control" id="floatingInput middle_name"
                                        ...
                                        <div class="form-floating mb-3">
                                            <select class="form-control p-3" id="specialties" name="specialties">
                                                ...
                                                @foreach ($infos as $info)
                                                    <option value="{{ $info->specialties }}">{{ $info->specialties }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput reason"
                                            name="reason" placeholder="Reason For Appointment" />
                                    ...
                                    <div class="d-flex mt-1 justify-content-between">
                                        <div class="form-check">
                                            <input class="form-check-input input-primary" type="checkbox" id="check"
                                                name="check" />
                                            <label class="form-check-label text-muted" for="customCheckc1">I agree to the
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header bg-primary text-light">
                                                <h3 class="modal-title" id="staticBackdropLabel">Create Doctor Appointment</h3>
                                            </div>
