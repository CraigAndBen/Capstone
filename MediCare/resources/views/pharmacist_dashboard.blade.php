...
<head>
    <title> MediCare | Pharmacist Dashboard </title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
...
<body>
    ...
    <header class="pc-header">
        <div class="m-header mt-3">
            ...
            <a href="{{ route('pharmacist.dashboard') }}" class="logo me-auto"><img src="{{ asset('logo.jpg') }}"
                                    ...
                                    <div class="list-group list-group-flush w-100">
                                        ...
                                        @foreach ($limitNotifications as $notification)
                                            <a class="list-group-item list-group-item-action"
                                                href="{{ route('pharmacist.notification') }}">
                                                <div class="d-flex">
                        ...
                        <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
                            <div class="dropdown-header">
                                ...
                                <div class="profile-notification-scroll position-relative"
                                    ...
                                    <a href="{{ route('pharmacist.profile') }}" class="dropdown-item">
                                        <i class="ti ti-settings"></i>
                                    ...
                                    <a href="{{ route('pharmacist.logout') }}" class="dropdown-item">
    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header">
                <div class="mt-3">
                    <a href="{{ route('staff.dashboard') }}" class="logo me-auto"><img
            ...
            <div class="navbar-content">
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item">
                        <a href="{{ route('pharmacist.dashboard') }}" class="pc-link"><span class="pc-micon"></span><span
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('pharmacist.profile') }}">Update
                                    Profile</a></li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link"><span class="pc-micon"></span><span
                                class="pc-mtext">Notification List</span><span class="pc-arrow"><i
                                    class="ti ti-chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" href="{{ route('pharmacist.notification') }}">Notification</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
